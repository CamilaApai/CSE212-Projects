public class Node
{
    ...
    public bool Contains(int value)
    {
        ...
        if (value >= Data)
        {
            ...
            // If the value is not found in the right child node, recursively search in the right subtree
    ...
    public int GetHeight()
    {
        ...
        // Return the maximum height of both subtrees plus 1 for the current node
