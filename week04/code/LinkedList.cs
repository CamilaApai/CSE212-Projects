...
public class LinkedList : IEnumerable<int> {
    ...
    public void InsertTail(int value) {
        ...
        // If the list is not empty, then only tail will be affected.
            ...
            newNode.Prev = _tail; // Connect the new node to the tail
    ...
    public void RemoveTail() {
        ...
        // will be affected.
            ...
            _tail = _tail.Prev; // Set the tail to be the second to last node (tail = tail.Prev)
        }
    }
    ...
    public void Remove(int value) {
        ...
        while (curr is not null) {
            if (curr.Data == value) {
                // If the location of the 'value' is at the head, then we can call RemoveHead
                if (curr == _head) {
                RemoveHead();
                }
                // If the location of the 'value' is at the tail, then we can call RemoveTail
                else if (curr == _tail) {
                    RemoveTail();
                }
                // For any other location of 'value', need to create a 
    ...
    public void Replace(int oldValue, int newValue) {
        ...
        Node? curr = _head;
        while (curr is not null) {
             // If the current node contains the old value, it will be replace with the new one
